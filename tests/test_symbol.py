...
class Tests_Symbol_Since_V7(unittest.TestCase):
    ...
    def test_textBoxAllVariants(self):
        ...
        self.testData.pathToTestFile = path.join(SYMBOL_BASE, 'v8', 'test_textBoxAllVariants')
    ...
    def test_rectangleAllVariants(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(SYMBOL_BASE, 'v8', 'test_rectangleAllVariants')
        symbolLib = SymbolLib().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(symbolLib, self.testData))
    ...
    def test_circleAllVariants(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(SYMBOL_BASE, 'v8', 'test_circleAllVariants')
        symbolLib = SymbolLib().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(symbolLib, self.testData))
    ...
    def test_arcAllVariants(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(SYMBOL_BASE, 'v8', 'test_arcAllVariants')
        symbolLib = SymbolLib().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(symbolLib, self.testData))

class Tests_Symbol_V8_Format(unittest.TestCase):
    """Test cases for KiCad v8 symbol format"""
    ...
    def test_allSymbolPinVariations(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(SYMBOL_BASE, 'v8', 'test_allSymbolPinVariations')
        symbolLib = SymbolLib().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(symbolLib, self.testData))
    ...
    def test_allSymbolAlternatePins(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(SYMBOL_BASE, 'v8', 'test_allSymbolAlternatePins')
        symbolLib = SymbolLib().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(symbolLib, self.testData))
    ...
    def test_symbolParameters(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(SYMBOL_BASE, 'v8', 'test_symbolParameters')
        symbolLib = SymbolLib().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(symbolLib, self.testData))
    ...
    def test_symbolDemorganUnits(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(SYMBOL_BASE, 'v8', 'test_symbolDemorganUnits')
        symbolLib = SymbolLib().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(symbolLib, self.testData))
    ...
    def test_symbolDemorganSyItems(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(SYMBOL_BASE, 'v8', 'test_symbolDemorganSyItems')
        symbolLib = SymbolLib().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(symbolLib, self.testData))
    ...
    def test_bigSymbolLibrary(self):
        ...
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(SYMBOL_BASE, 'v8', 'test_bigSymbolLibrary')
        symbolLib = SymbolLib().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(symbolLib, self.testData))
    ...
    def test_createNewSymbolInEmptyLibrary(self):
        ...
        symbol library"""
        self.testData.compareToTestFile = True
        self.testData.pathToTestFile = path.join(SYMBOL_BASE, 'v8', 'test_createNewSymbolInEmptyLibrary')
    ...
    def test_renameParentIdUsingIdToken(self):
        ...
        self.testData.pathToTestFile = path.join(SYMBOL_BASE, 'v8', 'test_renameParentIdUsingIdToken')
        symbolLib = SymbolLib().from_file(self.testData.pathToTestFile)
    ...
    def test_createNewTopLevelSymbolFromChild(self):
        ...
        self.testData.pathToTestFile = path.join(SYMBOL_BASE, 'v8', 'test_createNewTopLevelSymbolFromChild')
        symbolLib = SymbolLib().from_file(self.testData.pathToTestFile)
    ...
    def test_mergeLibraries(self):
        ...
        self.testData.pathToTestFile = path.join(SYMBOL_BASE, 'v8', 'test_mergeLibraries')
        symbolLib1 = SymbolLib().from_file(self.testData.pathToTestFile)
        symbolLib2 = SymbolLib().from_file(path.join(SYMBOL_BASE, 'v8', 'test_symbolDemorganSyItems'))
    ...
    def test_symbolIdParser(self):
        ...
        """
        self.testData.pathToTestFile = path.join(SYMBOL_BASE, 'v8', 'test_symbolIdParser')
        self.testData.compareToTestFile = True
        symbolLib = SymbolLib().from_file(self.testData.pathToTestFile)
        self.assertTrue(to_file_and_compare(symbolLib, self.testData))
